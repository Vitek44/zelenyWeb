...
const Table = (props) => {
  ...
  const { shape, edge, legs, material, value } = useCustomization();
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        geometry={nodes.Ctverec45.geometry}
        position={[0, 0, 0]}
        scale={[1, 0.005, 1]}
        visible={edge === 2 && shape === 1}
      >
        <meshStandardMaterial
          {...(material === "wood1" ? wood1TextureProps : wood2TextureProps)}
        />
      ...
      <mesh
        geometry={nodes.CtverecSmooth.geometry}
        position={[0, 0, 0]}
        scale={[1, 0.015, 1]}
        visible={edge === 3 && shape === 1}
      >
        <meshStandardMaterial
          {...(material === "wood1" ? wood1TextureProps : wood2TextureProps)}
        />
      ...
      <mesh
        geometry={nodes.Kruh45.geometry}
        position={[0, 0, 0]}
        scale={[1, 0.01, 1]}
        visible={edge === 2 || (edge === 3 && shape === 2)}
      >
        <meshStandardMaterial
          {...(material === "wood1" ? wood1TextureProps : wood2TextureProps)}
        />
      ...
      <mesh
        geometry={nodes.hexagon45.geometry}
        scale={[1.2, 1, 1.2]}
        visible={edge === 2 && shape === 4}
      >
        <meshStandardMaterial
          {...(material === "wood1" ? wood1TextureProps : wood2TextureProps)}
        />
      ...
      <mesh
        geometry={nodes.hexagonSmooth.geometry}
        scale={[1.2, 1, 1.2]}
        visible={edge === 3 && shape === 4}
      >
        <meshStandardMaterial
          {...(material === "wood1" ? wood1TextureProps : wood2TextureProps)}
        />
      ...
      <mesh
        ...
        position={[delka / 2 + 0.9, -0.5, -0.9]}
        scale={[0.05, 0.5, 0.05]}
        visible={shape === 1 || shape === 3}
      >
        <meshStandardMaterial
          {...(material === "wood1" ? wood1TextureProps : wood2TextureProps)}
        />
